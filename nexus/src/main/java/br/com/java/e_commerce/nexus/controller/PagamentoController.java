...
public class PagamentoController {
    ...
    public ResponseEntity<?> confirmarPagamentoApi(@PathVariable Long id) {
        try {
            ...
            // ⭐ ALTERAÇÃO EDUCACIONAL: NÃO altera o status do pedido
            // O pedido permanece como EM_ABERTO (Aguardando Pagamento)
            // O método confirmarPagamento do service original altera o status do pedido.
            // Removemos essa chamada para manter o status inalterado.
